...
class Default extends React.Component{
  ...
  cancelButton(){
    ...
    render(){
        ...
        <div className="qwe">
              <NavLink to={"/shop"} className="iconfont icon-kefu liney"><span className="size">在线客服</span></NavLink>
              <NavLink to={"/connect"}  className="iconfont icon-shoucang2 liney" ><span className="size">收藏</span></NavLink>
